...
// PapOrderQuery 查询代扣订单.
func PapOrderQuery(clt *core.Client, req map[string]string) (resp map[string]string, err error) {
	return clt.PostXML("/pay/paporderquery", req)
}

type PapOrderQueryRequest struct {
...
type PapOrderQueryResponse struct {
	XMLName struct{} `xml:"xml" json:"-"`
...
// PapOrderQuery2 查询订单.
//  NOTE: 该函数不支持 代金券 功能, 如果有 代金券 功能请使用 PapOrderQuery 函数.
func PapOrderQuery2(clt *core.Client, req *PapOrderQueryRequest) (resp *PapOrderQueryResponse, err error) {
